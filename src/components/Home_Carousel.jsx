...
function SamplePrevArrow(props) {
  ...
  return (
    ...
    //   onClick={onClick}
    // >
    //   <FaChevronLeft className="text-4xl text-black " />
    // </div>
  );
}
    ...
    <div className="slider-container relative">
      <Slider {...settings}>
        <div className="relative">
          ...
          <div className="absolute z-20 top-12 md:top-[25%] md:w-[25rem] md:h-[27rem] left-[11%] flex justify-center items-center">
